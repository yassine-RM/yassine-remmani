...
export const en = {
  ...
  resumePage: {
    ...
    snapshot: {
      ...
      experienceDesc: 'Building production web platforms end-to-end.',
      backendLabel: 'Java · Spring Boot',
      backendDesc: 'REST APIs, JPA/Hibernate, Kafka, secure auth.',
      frontendLabel: 'React · Next.js',
      frontendDesc: 'TypeScript, TailwindCSS, shadcn/ui, SSR.',
      devopsLabel: 'Docker · CI/CD · AWS',
      devopsDesc: 'Containerized deploys, automated pipelines, cloud.',
    },
    skills: {
      title: 'Core skills',
      backend: 'Backend',
      ...
      qualityItems: ['Clean architecture', 'Code reviews', 'Refactoring', 'Production fixes', 'Monitoring & logs'],
    },
    experience: {
      title: 'Experience',
    },
    ...
    languages: {
      ...
      french: 'French — Conversational / Professional',
      english: 'English — Conversational / Professional',
    },
    bestFit: {
      title: 'Best fit roles',
      subtitle: 'Open to senior full-stack and backend-focused positions.',
      roles: [
    ...
    finalCta: {
      ...
      subtitle: 'Download my CV, browse my projects, or get in touch directly.',
    },
  },
  skillsPage: {
    h1: 'Skills',
  ...
  cv: {
    ...
    projects: [
      { name: 'Facebook Marketplace Auto-Publishing System — Auto Dealers Digital', stack: 'Spring Boot · Kafka · PostgreSQL · Docker · Event-driven architecture', description: 'Automated vehicle publishing workflow driven by inventory updates and per-dealer settings. Vehicle events flow through Kafka asynchronously with rules like daily posting limits — more listing visibility, less manual work.' },
    ...
    filename: 'Yassine_Remmani_Resume.pdf',
  },
